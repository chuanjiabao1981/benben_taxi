module Permissions
  class PassengerPermission < BasePermission
    def initialize(user)
      ...
      allow_param :taxi_request,[:passenger_mobile,:passenger_lat,:passenger_lng,:waiting_time_range,:passenger_voice,:passenger_voice_format,:driver_score,:comments_attributes=>[:content]]
